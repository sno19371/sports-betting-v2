...
class FeatureEngineer:
    ...
    def create_features(
        ...
        Args:
            ...
            schedule_df: Game-level data (opponent, weather, spread, etc.)
                        Must have columns: season, week, team, opponent
                        Optional columns: wind_speed, temp, is_dome, spread_line
        ...
        if schedule_df is not None:
            ...
            merge_keys = ['season', 'week']
            
            # Add team to merge keys if both DataFrames have it
            if 'team' in result_df.columns and 'team' in schedule_df.columns:
