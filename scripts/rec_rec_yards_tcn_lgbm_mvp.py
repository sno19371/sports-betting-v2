# rec_rec_yards_tcn_lgbm_mvp.py
# MVP: 6-game Rec-TCN -> LightGBM for receiving yards, with weather.
...
log = logging.getLogger("rec_yards_mvp")
...
def main():
    ...
    log.info("Training LightGBM head for receiving yards…")
    callbacks = [
